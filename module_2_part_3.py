"""
module_2_part_3.py — Часть 3 Модуля 2: импорт геометрии из .mct файла
...
from data_structures import (
    Element, Node, PierModel, SpringSupport, _RawNode, _RawElement, _RawSpring, PileLoadResult, MctLoadResult,
)
